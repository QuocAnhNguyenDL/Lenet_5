...
module conv556 #(parameter COL = 5, BIT_WIDTH = 8, OUT_WIDTH = 32)(
    input clk, en,
    ...
    input [BIT_WIDTH-1:0] in1[0:5],
    input [BIT_WIDTH-1:0] in2[0:5],
    input [BIT_WIDTH-1:0] in3[0:5],
    input [BIT_WIDTH-1:0] in4[0:5],
    input [BIT_WIDTH-1:0] in5[0:5],
    ...
    conv55 #(.COL(COL), .BIT_WIDTH(BIT_WIDTH), .OUT_WIDTH(OUT_WIDTH)) layer_1(
        .clk(clk),
        .en(en),
        .kernel(kernel_0),
    ...
    conv55 #(.COL(COL), .BIT_WIDTH(BIT_WIDTH), .OUT_WIDTH(OUT_WIDTH)) layer_2(
        .clk(clk),
        .en(en),
        .kernel(kernel_1),
    ...
    conv55 #(.COL(COL), .BIT_WIDTH(BIT_WIDTH), .OUT_WIDTH(OUT_WIDTH)) layer_3(
        .clk(clk),
        .en(en),
        .kernel(kernel_2),
    ...
    conv55 #(.COL(COL), .BIT_WIDTH(BIT_WIDTH), .OUT_WIDTH(OUT_WIDTH)) layer_4(
        .clk(clk),
        .en(en),
        .kernel(kernel_3),
    ...
    conv55 #(.COL(COL), .BIT_WIDTH(BIT_WIDTH), .OUT_WIDTH(OUT_WIDTH)) layer_5(
        .clk(clk),
        .en(en),
        .kernel(kernel_4),
    ...
    conv55 #(.COL(COL), .BIT_WIDTH(BIT_WIDTH), .OUT_WIDTH(OUT_WIDTH)) layer_6(
        .clk(clk),
        .en(en),
        .kernel(kernel_5),
